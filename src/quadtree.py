...
class Rect:
    def __init__(self, left, top, right, bottom):
        ...
        self.bottom = bottom
    def __hash__(self):
        return hash(str(self.left)+str(self.right)+str(self.top)+str(self.bottom))
    
        
q = QuadTree(items = [Rect(5, 10, 10, 5),Rect(0, 5, 5, 0)], bounding_rect = (0,300,300,0))
print q.items
print q.hit(Rect(0, 100, 100, 0))
